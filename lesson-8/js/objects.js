...
let person = {
    ...
    bio: function() {
        alert(this.name.firstName + this.name.lastName + ' is ' + this.age + ' years old. They are a ' + this.age + ' year old ' +this.gender + ' who likes ' + this.interests.join(', ') + '.');
    }
}
...
person.goodbye = function() {
    return `Goodbye, ${this.name.firstName} ${this.name.lastName}!`;
}
